...
from core.semantic_boundary import (
    NARRATIVE_SECTIONS,
...
def extract_resume_sections(text: str):
    ...
    Architecture:
    - Section aliases live in ``core.section_aliases`` so resume vocabulary can
    ...
    - Semantic boundary repair lives in ``core.semantic_boundary`` so future
